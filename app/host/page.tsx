            ...
            <div className="mx-auto grid max-w-5xl grid-cols-1 gap-6 py-12 md:grid-cols-3">
              ...
              <Card>
                <CardHeader>
                  <div className="flex items-center gap-4">
                    <Image
                      src="https://images.unsplash.com/photo-1494790108377-be9c29b29330?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3"
                      alt="Host"
                      width={60}
                      height={60}
                      className="rounded-full object-cover"
              ...
              <Card>
                <CardHeader>
                  <div className="flex items-center gap-4">
                    <Image
                      src="https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3"
                      alt="Host"
                      width={60}
                      height={60}
                      className="rounded-full object-cover"
        ...
        <section className="w-full py-12 md:py-24 lg:py-32">
          <div className="container px-4 md:px-6">
            <div className="grid gap-6 lg:grid-cols-[1fr_400px] lg:gap-12 xl:grid-cols-[1fr_500px]">
              ...
              <div className="mx-auto w-full max-w-[500px] lg:max-w-none">
                <Image
                  src="https://images.unsplash.com/photo-1590674899484-d5a74bf2e5c4?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3"
                  alt="Host your parking spot"
                  width={800}
                  height={550}
                  className="mx-auto aspect-video overflow-hidden rounded-xl object-cover object-center sm:w-full"
